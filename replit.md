...
- June 14, 2025. Hunter Communicator Mobile Optimization - Dramatically enhanced HunterCommunicatorSystem15 for superior mobile experience. Expanded conversation items to 220px minimum height with 48px padding, increased avatar size to 28x28 (112px), enlarged text sizes significantly (name: 2xl, message: xl, timestamp: lg), improved spacing between items to 8 units, optimized chat area with reduced mobile spacing, enhanced message input with 52px height and proper text selection, improved send button with 48px minimum touch target, made modal full-width on mobile, and added smooth touch scrolling throughout. Interface now provides tablet-like touch targets on mobile devices while preserving premium frosted glass design.
