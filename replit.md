...
- June 22, 2025. World Map Mobile Responsiveness & Daily Life Icon Update COMPLETED - Enhanced WorldMapSystem8 with comprehensive mobile optimization including responsive header/legend panels, increased location node touch targets from 36px to 44px, optimized zone labels to prevent overlapping, bottom-sheet confirmation panels for mobile, and improved button sizing. Added mobile-specific CSS classes for better touch interaction. Changed Daily Life icon from gift/present to home icon for better semantic representation of daily activities.
