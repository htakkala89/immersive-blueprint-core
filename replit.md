...
- June 22, 2025. Dialogue Interface Height Expansion COMPLETED - Increased in-person dialogue container height from 55% to 70% of viewport to provide much more comfortable reading space for Cha Hae-In's responses. Users no longer need to scroll up to read the beginning of her messages, as the expanded dialogue area now accommodates longer conversations without cutting off text. Enhanced user experience with better conversation flow and readability on all screen sizes.
