...
- June 21, 2025. Premium Cinematic Text Formatting - Completely redesigned message formatting system with cinematic block-level presentation. Dialogue now appears in clean white text, actions in amber italics as stage directions, thoughts indented in gray italics as private asides. Enhanced typography with proper line height (1.6), letter spacing, font weights, and visual hierarchy. Added dedicated CSS classes for premium script-like presentation with enhanced shadows and spacing for mobile readability.
