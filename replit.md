...
- June 15, 2025. Combat System Mobile Optimization - Completely optimized EnhancedCombatSystem for mobile devices with responsive grid layout, larger touch targets (60px minimum height), 2-column action button grid on mobile, responsive text sizing, improved spacing and padding throughout, touch-friendly interactions with active states, and seamless cross-device compatibility. Fixed Strike button functionality issues during mobile optimization process.
