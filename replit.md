...
- June 15, 2025. Combat Interface Redesign - Redesigned combat system with compact attack list interface replacing bulky grid buttons. Enemies now clearly visible in center battle arena with streamlined scrollable attack list at bottom. Maintains all combat functionality while dramatically improving visual balance and user experience. Fixed variable reference errors for proper MP cost validation on all abilities.
