...
- June 14, 2025. Hunter Communicator Mobile Optimization - Enhanced HunterCommunicatorSystem15 for optimal mobile experience. Improved conversation item touch targets with 72px minimum height, responsive padding (12px on mobile, 16px desktop), optimized chat area with reduced spacing on mobile, enhanced message input with 52px minimum height and proper text selection, improved send button with 48px minimum touch target, and added smooth touch scrolling throughout. All interactive elements now meet mobile accessibility standards while preserving the premium frosted glass design.
