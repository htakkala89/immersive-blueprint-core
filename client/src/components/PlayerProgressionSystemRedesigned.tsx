            ...
            <div className="h-full overflow-y-auto p-4 sm:p-6">
              ...
              {activeTab === 'stats' && (
                ...
                >
                  ...
                  <div className="grid gap-3 max-h-[320px] sm:max-h-[400px] overflow-y-auto scrollbar-hide -webkit-overflow-scrolling-touch">
              ...
              {activeTab === 'equipment' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  transition={{ duration: 0.2 }}
                  className="space-y-4 sm:space-y-6 max-h-[320px] sm:max-h-[400px] overflow-y-auto scrollbar-hide"
                >
                  <div className="text-center">
