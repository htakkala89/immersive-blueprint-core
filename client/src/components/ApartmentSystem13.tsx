...
export function ApartmentSystem13({
  ...
  const homeTiers: HomeTier[] = [
    ...
    },
    {
      ...
      interiorPrompt: 'masterpiece, best quality, sharp focus, manhwa art style, Korean webtoon aesthetic, clean lines, detailed architectural illustration, cinematic lighting, photorealistic details, the spacious, sun-drenched interior of a modern high-rise apartment in Gangnam. Open-plan living room with a large, plush grey sectional sofa. Polished hardwood floors. Floor-to-ceiling windows reveal a stunning daytime city view of Seoul. A sleek, minimalist kitchen with marble countertops is visible.',
      exteriorPrompt: 'masterpiece, best quality, sharp focus, manhwa art style, Korean webtoon aesthetic, clean lines, detailed architectural illustration, cinematic lighting, photorealistic details, the exterior of a sleek, modern glass and steel skyscraper in Gangnam, Seoul. View from below looking up at the impressive, clean architectural lines against a clear blue sky.',
      interactiveNodes: [
        {
          id: 'sofa',
          position: { x: 40, y: 65 },
