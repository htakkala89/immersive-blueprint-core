  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-sf-pro">
      ...
      >
        ...
        <motion.button
          className="absolute top-6 left-6 w-12 h-12 liquid-glass rounded-full flex items-center justify-center z-40"
        ...
        <motion.div
          className="absolute top-6 left-20 liquid-glass-enhanced px-3 py-2 max-w-64"
